defmodule ChapterThreeTests do
  ...
  test "It should count the length of each line for a file" do
    assert (
      ChapterThree.line_lenghts!("/home/fabio_fusimoto/code/elixir/LearningElixir/test/fixtures/lines.txt") ==
  ...
  test "It should return the longest line's length" do
    assert (
      ChapterThree.longest_line_length!("/home/fabio_fusimoto/code/elixir/LearningElixir/test/fixtures/lines.txt") ==
        84
    )
  end
  ...
  test "It should return the longest line's content" do
    assert (
      ChapterThree.longest_line!("/home/fabio_fusimoto/code/elixir/LearningElixir/test/fixtures/lines.txt") ==
